  ...
  return (
    <Layout>
      <div className='w-5/6 h-auto py-2 px-5 sm:py-4 sm:px-10 md:py-8 md:px-20 border-l-2 border-black dark:border-white'>
        ...
        <div className="flex flex-wrap justify-around bg-repeat-space sm:bg-[url('https://raw.githubusercontent.com/JuanDls01/Portfolio/projectCard2/my-app/public/Background.png')] bg-transparent">
          {
